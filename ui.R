...
shinyUI(bootstrapPage(
    ...
    headerPanel("Binary (1-0) Data Converter"),
...
#------------------------------------------#
    ...
    mainPanel(
        ...
        tabPanel("Main",
            ...
            br(),
            p("Input answer keys (Either numeric or character, case-sensitive):",br(),
            "Input values must be separated by tabs or spaces."),
